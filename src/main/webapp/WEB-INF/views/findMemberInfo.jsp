...
<head>
<meta charset="UTF-8">
<title>Member Id/Password찾기</title>
</head>
	...
	<form name="logInForm" action="LogInMember" method="post">
		<div id="basic">
			...
			<div id="mid1">
				...
				<div id="user"><span class="user" onClick="getNewPage('findMemberInfo')">일반사용자</span></div>
				<div id="owner"><span class="owner"onClick="getNewPage('findStoreInfo')">업체사장님</span></div>
				
				<div id="login_type">	
					<div id="memberlogin_btn">
						<div class="login_type1" onClick="getNewPage('findMemberId')">
							<span>아이디 찾기<br></span>
					...
					<div id="storelogin_btn">
						<div class="login_type2" onClick="getNewPage('findMemberPassword')">
